...
architecture Settings of BigDesign_TestController is
begin
	ControlProc: process
		constant ProcID  : AlertLogIDType := NewID("ControlProc", TCID);
		constant TIMEOUT : time := 1 ms;
	begin
		SetTestName("BigDesign_Settings");
	...
	begin
		...
		ReadCheck(HPM0_LPD_Rec, REG_SETTINGS_BAUDRATE, 32x"E1000");  -- 921.600 kBd
...
configuration BigDesign_Settings of BigDesign_TestHarness is
	for TestHarness
		for TestCtrl: BigDesign_TestController
			use entity work.BigDesign_TestController(Settings);
		end for;
	end for;
end configuration;
